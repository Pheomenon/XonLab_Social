...
public class UserController {
	...
	public void updateFansAndFallow(@PathVariable String userid,
									@PathVariable String friendid,
									@PathVariable int x){
		userService.updateFansAndFallow(x,userid,friendid);
	}
	...
	public Result regist(@PathVariable String code,
		...
		//得到缓存中的验证码
		String redisCheckCode = (String)redisTemplate.opsForValue().get("randomNumber_" + user.getMobile());
